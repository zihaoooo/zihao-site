...
- Images: follow the image standard in the root `CLAUDE.md`. The encoder keeps alpha, so a cutout that overlaps the content above it (Seed Bomb's `flowercolalge_bottom.avif`) stays transparent.
